"""
Generate stories using fine-tuned instruction-following model.
...
def generate_story(
    ...
    Args:
        model: Fine-tuned GPT-2 model in eval mode
        ...
        eos_id: End-of-sequence token ID (50256 for <|endoftext|>)
